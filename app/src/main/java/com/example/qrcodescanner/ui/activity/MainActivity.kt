...
import com.example.qrcodescanner.analysis.QrCodeAnalyzer
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            // Preview
            val previewView = binding.viewFinder.surfaceProvider
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CODE_PERMISSIONS) {
            if (allPermissionsGranted()) {
                ...
                Toast.makeText(
                    this,
                    "As permissões necessárias não foram aceitas!",
                    Toast.LENGTH_SHORT
                ).show()
                finish()
            }
